...
sub PrintHeaderEdit
{
	...
	$Page->Print("<tr><td colspan=2 align=center><div class=\"trix-\">");
	...
	$Page->Print("</div></td></tr>");
	$Page->Print("<tr><td class=\"DetailTitle\">内容編集</td><td>");
	$Page->Print("<input id=\"x\" value=\'$data\' type=\"hidden\" name=\"HEAD_TEXT\">\n");
	$data =~ s/&/&amp;/g;
	$data =~ s/</&lt;/g;
	$data =~ s/>/&gt;/g;
	$Page->Print("<trix-editor input=\"x\" class=\"trix-content\"></trix-editor></td></tr>\n");
